...
//THIS IS THE POLYGONS ADDON FOR PROPHECY PARADOX.
...
Class.ppPolygons = menu("Prophecy Paradox Polygons");
Class.ppPolygons.UPGRADES_TIER_0 = [];
Class.addons.UPGRADES_TIER_0.push("ppPolygons");
