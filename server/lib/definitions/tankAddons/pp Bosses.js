...
//THIS IS THE BOSSES ADDON FOR PROPHECY PARADOX.
...
Class.ppBosses = menu("Prophecy Paradox Bosses");
Class.ppBosses.UPGRADES_TIER_0 = [];
Class.addons.UPGRADES_TIER_0.push("ppBosses");
