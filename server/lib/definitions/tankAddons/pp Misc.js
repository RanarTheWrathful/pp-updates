...
//THIS IS THE MISC ADDON FOR PROPHECY PARADOX(Which includes things like walls and similar objects).
...
Class.ppMisc = menu("Prophecy Paradox Misc");
Class.ppMisc.UPGRADES_TIER_0 = [];
Class.addons.UPGRADES_TIER_0.push("ppMisc");
