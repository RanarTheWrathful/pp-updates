...
//THIS IS THE ENEMIES ADDON FOR PROPHECY PARADOX.
...
Class.ppEnemies = menu("Prophecy Paradox Enemies");
Class.ppEnemies.UPGRADES_TIER_0 = [];
Class.addons.UPGRADES_TIER_0.push("ppEnemies");
