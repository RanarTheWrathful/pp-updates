...
//THIS IS THE TURRETS ADDON FOR PROPHECY PARADOX
...
Class.ppTurrets = menu("Prophecy Paradox Turrets");
Class.ppTurrets.UPGRADES_TIER_0 = [];
Class.addons.UPGRADES_TIER_0.push("ppTurrets");
