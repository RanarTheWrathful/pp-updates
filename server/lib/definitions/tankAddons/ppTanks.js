...
const { makeRarities, makePresent, makeRelic, makeCrasher, makeLaby, menu, combineStats, skillSet, addAura, makeDeco, makeAuto, makeHybrid, makeOver, makeTurret, weaponArray, dereference, LayeredBoss, newWeapon, makeRadialAuto, setTurretProjectileRecoil, makeMulti } = require('../facilitators.js');
